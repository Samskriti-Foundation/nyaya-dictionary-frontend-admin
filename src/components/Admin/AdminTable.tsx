      ...
      <Flex justifyContent= "center" gap = "4" p = "4">
        ...
        <Popover>
          ...
          <PopoverContent>
            ...
            <PopoverBody>
              <Box>
                <Checkbox isChecked = {table.getIsAllColumnsVisible()} onChange = {table.getToggleAllColumnsVisibilityHandler()}>Toggle All</Checkbox>
              </Box>
              {table.getAllLeafColumns().map(column => (
                <Box key = {column.id}>
                  <Checkbox isChecked = {column.getIsVisible()} onChange = {column.getToggleVisibilityHandler()}> {`${column.columnDef.header}`} </Checkbox>
                </Box>
              ))}
            </PopoverBody>
          </PopoverContent>
